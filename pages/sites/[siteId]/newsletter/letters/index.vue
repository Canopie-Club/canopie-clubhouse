<template>
    <div class="w-full">
      ...
      <div class="flex gap-2 items-center py-4">
        <Button variant="outline" size="sm" @click="$router.push(`/sites/${siteId}/newsletter/letters/create`)">
      ...
      <div v-if="letters.length > pagination.pageSize" class="flex items-center justify-end space-x-2 py-4">
        <div class="pr-4">
  ...
  const columns: ColumnDef<ResponseLetter>[] = [
    {
      ...
      cell: ({ row }) => h("div", { class: "pl-4" }, row.original.subject),
    },
    {
      ...
      cell: ({ row }) => h("div", { class: "lowercase" }, row.original.createdAt),
    },
    {
